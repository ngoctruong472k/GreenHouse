...
Route::post("/post-dang-ky", [PageSiteController::class, "postRegister"])->name('post.page.dang.ky');
Route::get("/gioi-thieu", [PageSiteController::class, "getPageGioiThieu"])->name('get.page.gioi.thieu');
Route::get("/dao-tao", [PageSiteController::class, "getPageEdu"])->name('get.page.dao.tao');
