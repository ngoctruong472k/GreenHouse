...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('public/site/css/docs.theme.min.css') }}"> --}}
...
<link href="https://fonts.googleapis.com/css2?family=Anton&family=Lobster&family=Roboto:wght@300&display=swap" rel="stylesheet">
</head>
